            ...
            if sys.argv[2] == 'lc':
                for pen in ['l1', 'l2']:
                    for c_reg in [0.001, 0.01, 0.1, 1, 10, 100, 1000]:
                        ...
                        Fit_model_output_result(clf, f, file_name_pre, feature_no, model_param, train_x, train_y, val_x, val_y)
            elif sys.argv[2] == 'svm':
                for c_reg in [0.001, 0.01, 0.1, 1, 10, 100, 1000]:
                                    ...
                                    for coef0_val in [10]: #[0.001, 0.01, 0.1, 1, 10]:
                                        if kern_fun == 'poly':
                                            for deg_coef in [8, 10]: #[1, 2, 3, 5, 8, 10]:
                                                ...
                                                val_conf = Fit_model_output_result(clf, f, file_name_pre, feature_no, model_param, train_x, train_y, val_x, val_y)
                                        else:
