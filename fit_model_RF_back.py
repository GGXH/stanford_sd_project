...
if __name__ == '__main__':
    ...
    if coll_name in db.collection_names():
        ...
        best_variable_i = []
        best_variable_l = []
        all_output = open(sys.argv[1]+'all_output_RF.txt', 'wb')
        best_output = open(sys.argv[1]+'best_output_RF.txt', 'wb')
        ...
        while len(variable_list_best) > 1:
            ...
            for i in variable_i_best:
                ...
                if diff_val_y < best_error:
                    ...
                    clf_best = clf
            print best_i
            file_name = sys.argv[1]+'_RF_'+str(len(variable_list_best))+'.pkl'
