...
if __name__ == '__main__':
    ...
    if sys.argv[2] == 'lc':
        for pen in ['l2']: #['l1', 'l2']:
            for c_reg in [0.004, 0.003, 0.002, 0.001]: #[0.005, 0.002, 0.001, 0.0005]:  #[0.09, 0.08, 0.07, 0.06, 0.05, 0.04, 0.03]: #[0.5, 0.2, 0.1, 0.05, 0.02, 0.01]: #[0.001, 0.01, 0.1, 1, 10, 100, 1000]:
