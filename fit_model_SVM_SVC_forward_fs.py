...
if __name__ == '__main__':
    ...
    if coll_name in db.collection_names():
        ...
        best_variable_i = []
        best_variable_l = []
        all_output = open(sys.argv[1]+'_all_output_svm_svc_regression.txt', 'wb')
        best_output = open(sys.argv[1]+'_best_output_svm_svc_regression.txt', 'wb')
            ...
            for i in range(0, len(variable_list)):
                ...
                if i not in best_variable_i:
                    ...
                    if diff_val_y < best_error:
                        ...
                        best_i = i
                        clf_best = clf
            file_name = sys.argv[1]+'_SVM_svc_'+str(len(variable_list) - len(variable_list_tmp) + 1)+'.pkl'
